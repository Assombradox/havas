...
const HeroBanner: React.FC = () => {
    const [banners, setBanners] = useState<BannerData[]>([
        ...
        { id: 'static-3', src: "https://res.cloudinary.com/ddcjebuni/image/upload/v1769583924/asset-havaianas-outlet-60_-2_r3isra.gifasset-havaianas-outlet-60_-2_r3isra.gif", alt: "Outlet 60% OFF" },
