...
const DeliveryInfo: React.FC = () => {
    ...
    return (
        <section className="w-full py-6 font-sans border-t border-gray-100 mt-6 px-4">
            <div className="flex flex-col gap-4">
                ...
                <div className="flex gap-2 w-full max-w-sm">
                    <input
                        ...
                        className="flex-1 border border-gray-300 rounded-md px-3 py-2 text-sm focus:border-black focus:ring-1 focus:ring-black outline-none transition-all placeholder:text-gray-400"
                        maxLength={9}
                    />
                    <button
                        onClick={handleCalculate}
                        disabled={cep.length < 9}
                        className="bg-black text-white px-5 py-2 rounded-md text-sm font-medium hover:bg-gray-800 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                    >
                        Calcular
                    </button>
                </div>
